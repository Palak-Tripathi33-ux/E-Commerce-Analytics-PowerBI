...
Built an interactive E-Commerce Sales Dashboard using Microsoft Power BI
Visualizes sales performance, customer trends, and product-level insights
Designed to support data-driven decision-making for e-commerce businesses
Suitable for business analysts, managers, and stakeholders who need quick insights

🎯 Business Objective

Track total sales, profit, and order volume over time
Identify top-performing products and categories
Understand customer buying patterns across regions and segments
Spot low-performing areas that need attention
...
Sum of Profit — ₹26K total profit earned
...
Sum of Amount by Customer Name (Bar Chart) — Top customers: Harivansh, Shiva, Madhav, Sarita
Sum of Quantity by Category (Donut Chart) — Clothing dominates at 63%, Electronics 19%, Furniture 18%
...
Maharashtra generates the highest sales among all states, indicating a strong urban customer base
Printers lead in sub-category profit, while categories like Saree and Bookcases show lower margins
Profit grew from January to March, showing a positive Q1 trend across the business
...
Practiced choosing the right chart types for different business questions
...
Choosing visuals — Deciding between bar charts, line charts, and tables for each use case
...
Iterated on the design multiple times based on readability and visual clarity
Added slicers and cross-filtering to make the dashboard fully interactive
...
`Data Visualization` — Chart selection, color usage, layout design
`Business Thinking` — Framing analysis around real business questions
...
I plan to keep improving this dashboard by adding forecasting and more granular filters
